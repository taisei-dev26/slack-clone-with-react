...
function CreateWorkspaceModal(props: Props) {
  ...
  return (
    <div className="profile-modal-overlay" onClick={() => setShowCreateWorkspaceModal(false)}>
      <div className="profile-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="profile-modal-footer">
          {props.allowCancel && (
            <button className="cancel-button" onClick={() => setShowCreateWorkspaceModal(false)}>キャンセル</button>
          )}
          <button
